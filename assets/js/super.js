// ==========================================
// 👑 GOD MODE: SUPER ADMIN DASHBOARD (V35 - STRICT BLUE & GOLD PALETTE)
// ==========================================
    ...
    try {
        ...
        window.superUsersData.forEach((u) => {
            ...
            if (matchSearch && matchRole && matchKec) {
                ...
                // 🔥 V35: Logika Identitas Warna Biru-Emas Eksklusif
                let badgeClass = 'role-kader';
                if (role.includes('SUPER')) badgeClass = 'role-super';
                else if (role.includes('ADMIN_KABUPATEN')) badgeClass = 'role-adminkab';
                else if (role.includes('ADMIN_KECAMATAN') || role === 'ADMIN') badgeClass = 'role-adminkec';
    ...
    try {
        ...
        document.body.innerHTML = `
            ...
            <style>
                ...
                .super-table-container { max-height: calc(100vh - 280px); overflow-y: auto; border-radius: 8px; border: 1px solid #eee; background:white; } .super-table { width: 100%; border-collapse: collapse; font-size: 0.9rem; min-width: 1100px; } .super-table th { position: sticky; top: 0; z-index: 10; background: #0A2342; color: white; padding: 15px; text-align: left; font-weight:600; border-bottom: 3px solid #F1C40F; } .super-table td { padding: 12px 15px; border-bottom: 1px solid #eee; color: #444; vertical-align: top;} .super-table tr:hover td { background: #f8f9fa; }
                
                /* 🔥 V35: Blue & Gold Lencana Palette */
                ...
                .role-kader { background: #E8F4FD; color: #0043A8; border-color: #b6d4fe; } /* Very Light Blue */
                ...
                .role-mitra { background: #FFF8E7; color: #0043A8; border-color: #D4AF37; } /* Pale Gold + Royal Blue */
