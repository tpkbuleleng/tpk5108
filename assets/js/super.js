// ==========================================
// 👑 GOD MODE: SUPER ADMIN DASHBOARD (V35 - BLUE & GOLD EDITION)
// ==========================================
    ...
    try {
        ...
        document.body.innerHTML = `
            ...
            <style>
                ...
                .role-kader { background: #e8f4fd; color: #0043A8; border-color: #b6d4fe; } 
                .role-admin { background: #fdf3e8; color: #d35400; border-color: #f6c23e; } 
                .role-super { background: #0A2342; color: #F1C40F; border-color: #F1C40F; } 
                .role-pkb { background: #f3e8ff; color: #6f42c1; border-color: #d8b4e2; } 
                .role-mitra { background: #fff3cd; color: #d35400; border-color: #ffeeba; } 
                .role-desa { background: #e2fbf5; color: #16a085; border-color: #a3e4d7; }
