(function (window, document) {
  ...
  var PATCH_5E_R4C_R2_R1_VERSION = '5E-R4C-R2-R1-HARD-STOP-REFRESH-FORCE-CLIENT-CHAIN-20260507';
  var PATCH_5E_R4C_R2_VERSION = PATCH_5E_R4C_R2_R1_VERSION;
    ...
    try {
      if (force) {
        ...
        reportClientPerf('superAdminRefreshForceClientStart', startedAt, refreshMetricExtra(true, 'SUCCESS', {
          ...
          metric_duration_ms: Math.max(0, Date.now() - startedAt),
          detail: 'Refresh Paksa dimulai; frontend hard-stop aktif agar tidak memicu chain panel berat.'
        }));
      } else {
