(function (window, document) {
  ...
  function securityActionFormHtml() {
    return [
      '<section class="sa-panel" style="margin-top:12px">',
        ...
        '<p class="sa-muted">Gunakan tindakan ini hanya setelah membaca Security Risk. Revoke langsung menonaktifkan token aktif. Block/cooldown dicatat sebagai policy; enforcement login tetap dikendalikan bertahap oleh SecurityPolicyService/AuthService.</p>',
        '<div class="sa-filter">',
  ...
  function renderSecurityActionCenter(data) {
    ...
    target.innerHTML = [
      ...
      '<p class="sa-muted">Paket 5E-R4: execution test & enforcement guard. Update: ', escapeHtml(formatWita(data.generated_at)), ' · Service: ', escapeHtml(fmt(data.service_version)), '</p>',
