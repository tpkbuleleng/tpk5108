(function (window, document) {
  ...
  function renderSecurityRisk(data) {
    ...
    target.innerHTML = [
      ...
      '<p class="sa-muted">Paket 5D-R1 membaca log_security_event, log_user_login, dan sinyal performance untuk early warning. Paket ini belum melakukan auto-block atau revoke otomatis.</p>',
      '<section class="sa-grid">',
