(function (window, document) {
  ...
  function securityRiskHeaders(kind) {
    if (kind === 'login') {
      return [
        ...
        { key: 'status_login', label: 'Status' },
        { key: 'reason_code', label: 'Reason' },
        { key: 'perangkat', label: 'Device' },
  ...
  function renderSecurityRisk(data) {
    ...
    target.innerHTML = [
      ...
      '<p class="sa-muted">Paket 5D membaca log_security_event, log_user_login, dan sinyal performance untuk early warning. Paket ini belum melakukan auto-block atau revoke otomatis.</p>',
      '<section class="sa-grid">',
      ...
      '<section class="sa-layout">',
        ...
        '<div class="sa-panel"><h3>Top Reason</h3>', tableHtml([{ key: 'reason_code', label: 'Reason' }, { key: 'event_count', label: 'Jumlah' }], topReasons, 'security_reason'), '</div>',
        '<div class="sa-panel"><h3>Top User/Device</h3>',
          ...
          '<h4>Device</h4>', tableHtml([{ key: 'device_id', label: 'Device' }, { key: 'event_count', label: 'Jumlah' }], topDevices, 'security_top_device'),
        '</div>',
      '</section>',
