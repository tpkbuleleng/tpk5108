(function (window) {
  ...
  EVENT_TYPE: OBS_ENUM.EVENT_TYPE,
  DECISION_STATUS: OBS_ENUM.DECISION_STATUS,
  REASON_CODE: OBS_ENUM.REASON_CODE,
  BUSINESS_STATUS: OBS_ENUM.BUSINESS_STATUS,
  STATUS_SYNC: OBS_ENUM.STATUS_SYNC
};
